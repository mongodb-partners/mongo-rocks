...
namespace mongo {
    ...
    namespace {
        ...
        public:
            ...
            PrefixStrippingIterator(std::string prefix, rocksdb::TOTransaction* txn,
    ...
    RocksIterator* RocksRecoveryUnit::NewIterator(std::string prefix, bool isOplog) {
        ...
        return new PrefixStrippingIterator(std::move(prefix), _transaction.get(), it,
    ...
    RocksIterator* RocksRecoveryUnit::NewIteratorWithTxn(rocksdb::TOTransaction* txn,
        ...
        return new PrefixStrippingIterator(std::move(prefix), txn, it, nullptr,
                                           std::move(upperBound));
    }
